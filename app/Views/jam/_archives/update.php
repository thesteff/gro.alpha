...
<div class="main_block">
	...
	<h3 class="block_title">Modifier une jam</h3>
	<br>
	<div class="block_content_left">	
		...
		<?php echo form_open('jam/update/'.$jam_item['slug']) ?>
			...
			<div id="time_infos" class="small_block_info">
				<p>
					<input type="input" name="date_bal" size="3" list="horaires" class="numbers" value="<?php echo set_value('date_bal'); ?>" /> > balances<br>
					<?php echo form_error('date_bal'); ?>
					<input type="input" name="date_debut" size="3" list="horaires" class="numbers" value="<?php echo set_value('date_debut'); ?>" /> > début<br>
					<?php echo form_error('date_debut'); ?>
					<input type="input" name="date_fin" size="3" list="horaires" class="numbers" value="<?php echo set_value('date_fin'); ?>" /> > fin<br>
			...
			<div id="playlist_infos" class="small_block_info" style="display:none">
				<table class="listTab unactive" style="width:500;">
					<thead>
						<tr>
							<th></th>
			...
			<div id="admin_infos" class="small_block_info" style="display:block;">
				...
				<p>
					...
					<img id="adminAddBtn" class="clickableBtn" style='height: 12; display:none; filter:grayscale(100%)' src='/images/icons/add.png' title='ajouter coorganisateur' onclick='add_event_admin_request()'>
				</p>
