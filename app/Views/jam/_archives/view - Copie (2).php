		...
		<?php if (!$attend && !$attend_stage && !$jam_item['is_archived']) :?>
			...
			<div id="join_btn" style="display:block;">
				...
				<?php if (sizeof($list_members) >= $jam_item['max_inscr'] && $jam_item['max_inscr'] != -1) {
					echo "<p class='error'>nombre maximum de participants atteint !</p>";
				}
				else echo "<br><br>";
				?>
			...
			<div class="block_list_title soften">Liste des titres
				...
				<table class="list_content listTab bright_bg is_playable" style="width:550;">
					...
					<?php foreach ($playlist_item['list'] as $key=>$ref): ?>
						<tr class="list_elem" id="<?php echo $ref->versionId ?>" versionId="<?php echo $ref->versionId ?>">
						<?php if ($ref->versionId != -1): ?>
								...
								<td style="text-align: center"><?php if ($ref->soufflants == 1) echo "<img style='height: 12;' src='/images/icons/ok.png'>";?></td>
								<?php if ($stage_item != "null"):?>
