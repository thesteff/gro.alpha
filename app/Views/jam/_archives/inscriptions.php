		...
		<div class="block" style="width:38%; float:right;">
			...
			<?php if (isset($playlist_item["infos"]["pdfURL"]) && $playlist_item["infos"]["pdfURL"] != "") : ?>
				<div class="small_message" id="message1">
					<h4>pdf</h4>
					<div><p>Pdf rassemblant tous les morceaux de la jam avec sommaire : </p><p><b><a class="numbers" href="<?php echo base_url()."ressources/jam/".$playlist_item["infos"]["pdfURL"]; ?>" target="_blanck"><?php echo $playlist_item["infos"]["pdfURL"]; ?></a></b></p>
					</div>
				</div>
			<?php endif; ?>
