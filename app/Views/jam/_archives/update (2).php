<script type="text/javascript">
	...
	$(function() {
		...
		$("#jam_date").datepicker("setDate","<?php echo $jam_item['date_label']; ?>");
...
<div class="container-fluid">
	...
	<?php /*echo form_open('jam/update/'.$jam_item['slug'])*/ ?>
	
		<!----- TITRE / DATE / TEXTAREA  ------->
		<p style="width:93%;">
			<input type="input" name="title" size="45" placeholder="Titre de la jam" value="<?php echo set_value('title',$jam_item['title']); ?>" autofocus />
			<input type="input" name="date_label" id="date_label" size="10" class="date" style="float:right;text-align:center;" readonly><br />
			<?php echo form_error('title'); ?>
		</p>
	
		<p>
			<textarea id="jam_textarea" name="text" placeholder="Texte de la jam"><?php echo set_value('text',$jam_item['text']); ?></textarea>
		...
		<div id="lieu_infos" class="small_block_info" style="display:flex;">
			<div style="align-self:center"><img style="height: 16px; margin:0px 16px 0px 16px;" src="/images/icons/lieu.png" alt="lieu"></div>
			<div class="small_block_col">
				<p>
					<input id="lieu" type="input" name="lieu" size="30" list="lieux" placeholder="Lieu de la jam" value="<?php echo set_value('lieu',$lieu_item["nom"]); ?>" autocomplete="off" oninput="lieu_change('input')" onblur="lieu_change('blur')" />
					<datalist id="lieux">
		...
		<div id="time_infos" class="small_block_info">
			<p>
				<input type="input" name="date_bal" size="3" list="horaires" class="numbers" value="<?php echo set_value('date_bal',$jam_item['date_bal']); ?>" /> > balances<br>
				<?php echo form_error('date_bal'); ?>
				<input type="input" name="date_debut" size="3" list="horaires" class="numbers" value="<?php echo set_value('date_debut',$jam_item['date_debut']); ?>" /> > début<br>
				<?php echo form_error('date_debut'); ?>
				<input type="input" name="date_fin" size="3" list="horaires" class="numbers" value="<?php echo set_value('date_fin',$jam_item['date_fin']); ?>" /> > fin<br>
		...
		<p>
			...
			<input type="checkbox" name="got_max_inscr" <?php echo $jam_item['max_inscr'] > 0 ? 'checked' : ''; ?> />
			<input id='max_inscr' type="input" name="max_inscr" size="2" list="nb_inscr" class="numbers numbersOnly" value="<?php echo set_value('max_inscr',$jam_item['max_inscr']); ?>" style="text-align:right; <?php echo $jam_item['max_inscr'] > 0 ? '' : 'display:none'; ?>" /><br>
		...
		<p>
			...
			&nbsp;&nbsp;
			<label id="acces_inscr_label" for="acces_inscr" <?php if ($jam_item['playlistId'] == 0) echo "class='soften' style='opacity:0.6'"; ?>><small>Accès au tableau d'inscription</label></small>
			<input id="acces_inscr" name="acces_inscr" type="checkbox" value='1' <?php echo set_checkbox('acces_inscr','1',$jam_item['acces_inscriptions'] == 1); ?> <?php if ($jam_item['playlistId'] == 0) echo "disabled"; ?>>
		</p>
		
		<div id="playlist_infos" class="small_block_info" style="display:none">
			<table class="listTab unactive" style="width:500px;">
				<thead>
					<tr>
						<th></th>
						<th width="10px" style="text-align:center"><span class="choeurs"><img style='height: 12px;' src='/images/icons/heart.png' title='choeurs'></span></th>
						<th width="10px" style="text-align:center"><span class="soufflants"><img style='height: 16px; margin:0px 2px' src='/images/icons/tp.png' title='soufflants'></span></th>
						<th width="10px" style="text-align:center"><span class="stage"><img style='height: 16px;' src='/images/icons/metro.png' title='réservé aux stagiaires'></span></th>
					</tr>
				</thead>
				<tfoot>
					<tr>
						...
						<th width="10px" style="text-align:center"><img style='height: 14px; margin:0px 2px' src='/images/icons/metro.png'><span class="stage"></span></th>
					</tr>
				</tfoot>
				<tbody></tbody>
			</table>
		...
		<!-------- AFFECT ADMIN  --------->
		<p>
			<label for="benevole">Coorganisateurs</label>
		</p>
		<div id="admin_infos" class="small_block_info" style="display:block;">

			<p>
				<input id="adminInput" type="input" name="adminInput" size="40" list="membres" placeholder="Membre du gro" autocomplete="off" oninput="event_admin_input()" />
				<datalist id="membres">
			...
			<div id="admin_list" class="list_block" style="display:none">
			</div>
		...
		<!-- SUBMIT -->
		<input class="button" type="submit" name="submit" value="Modifier la jam" />
