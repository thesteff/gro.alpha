...
<div class="main_block">
	...
	<div id="songlist_content" class="block_content">
		...
		<!-- NBREF -->	
		<div class="small_block_list_title soften right"><small><span class="soften">(<span id="nbRef"><?php echo sizeof($list_song_ex); ?></span> références)</small></span></div>
		...
		<table id="songlist" class="tablesorter focus-highlight is_playable" cellspacing="0">
			<thead>
				<tr>
					...
					<th class="no_sort centerTD" connect="anneeInput"><span>Année</span></th>
